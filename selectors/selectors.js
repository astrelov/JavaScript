...
function hasNoParent(currentObj, dataArray) {
  return !dataArray.some((e) => {
    return currentObj.left > e.left && currentObj.right < e.right;
  });
}
...
function recursivePaste(index = 0, paddingCharAmount = 0) {
  ...
  if (hasNoParent(currentObj, dataArray)) {
    paddingCharAmount = 0;
  }
